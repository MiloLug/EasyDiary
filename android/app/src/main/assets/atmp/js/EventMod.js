...
EventMod.utils.getTargetElement = function(e){
	return e.toElement || e.target || e.relatedTarget || e.fromElement || e.srcElement || undefined;
};
...
EventMod.enableCssSelectors = function(){
	...
	EventMod.onMousemove(window, wElem);
